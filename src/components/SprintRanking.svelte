...
import {currentGame} from "$stores/stores.js"
  ...
  <div>
    <ion-row><ion-col><h2>Clasificación por puntos tras {$currentGame.currentStage-1}/{$currentGame.totalStages} etapas</h2></ion-col></ion-row>
...
<ion-row class="ion-align-items-center  ">    
    ...
    <ion-col size="3"  class="center subtitle"><span class="marker" style="padding: 0.6em;" >{cyclist.awards.sprintPoints}</span></ion-col>
    <hr>
</ion-row>
{/each}
